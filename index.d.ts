import {ActionCode} from "@swp/swipe-sdk"
...
declare module '@swp/swipe-sdk' {
    ...
    export interface NewTrailTransfer {
        from: string
        to: string
        amount: string
        asset?: string
    ...
    export interface SwipeEndpoints {
        ...
        getAllTrailTransfers: (filter: TrailTransferFilter, pag: PaginationOptions) => Promise<SuccessResponse<Array<Data<TrailTransfer>>>>
